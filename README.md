...
- 🌐 I speak English (upper intermediate), Japanese (intermediate), German (intermediate), Chinese (very basic), and Vietnamese (native)
- ⚡ Tech Stack: java, spring, libgdx, c++, cocos2dx, ts, js, nodejs, docker, threejs
